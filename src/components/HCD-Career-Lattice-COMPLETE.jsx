...
const HCDCareerLattice = () => {
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '8px' }}>
                    {Object.entries(competencies.core).map(([comp, level]) => (
                      <div key={comp} style={{ padding: '8px 10px', backgroundColor: '#F0F8FF', borderRadius: '6px', fontSize: '0.8rem', color: colors.navy, borderLeft: '3px solid ' + colors.orange }}>
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '8px' }}>
                    {Object.entries(competencies.technical).map(([comp, level]) => (
                      <div key={comp} style={{ padding: '8px 10px', backgroundColor: '#FFF0E6', borderRadius: '6px', fontSize: '0.8rem', color: colors.navy, borderLeft: '3px solid #FF9500' }}>
                        <div style={{ fontWeight: 'bold' }}>{comp}</div>
                        <div style={{ fontSize: '0.7rem', color: '#666' }}>{level}</div>
                      </div>
                    ))}
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '6px' }}>
                  {training.modules.map((module, idx) => (
                    <div key={idx} style={{ padding: '6px 10px', backgroundColor: colors.light, borderRadius: '4px', fontSize: '0.75rem', color: colors.navy, border: '1px solid ' + colors.border }}>
                      ✓ {module}
                    </div>
                  ))}
                </div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ backgroundColor: 'white', border: '2px solid ' + colors.orange, borderRadius: '12px', padding: '20px', marginBottom: '30px' }}>
            ...
            {customPath.map((roleTitle, idx) => (
              <div key={idx} style={{ backgroundColor: colors.light, padding: '10px 12px', borderRadius: '6px', marginBottom: '8px', borderLeft: '4px solid ' + colors.orange }}>
            ...
            <div style={{ backgroundColor: 'white', border: '2px solid ' + colors.border, borderRadius: '12px', padding: '20px', marginBottom: '20px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '10px' }}>
                {availableRoles.slice(0, 12).map((role, idx) => (
                  <button key={idx} onClick={() => setCustomPath([...customPath, role.title])} style={{ padding: '10px 12px', backgroundColor: colors.light, border: '1px solid ' + colors.border, borderRadius: '6px', cursor: 'pointer', fontSize: '0.8rem', fontWeight: 'bold', color: colors.navy }}>
                    {role.title}
                ...
                <div style={{ backgroundColor: '#FFF9E6', border: '2px solid ' + colors.orange, borderRadius: '8px', padding: '16px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '8px' }}>
                    {nextTraining.modules.map((module, idx) => (
                      <div key={idx} style={{ padding: '8px 12px', backgroundColor: colors.cream, borderRadius: '4px', fontSize: '0.8rem', color: colors.navy, border: '1px solid ' + colors.border }}>
                        ✓ {module}
                      </div>
                    ))}
                  </div>
            ...
            <div style={{ marginBottom: '30px' }}>
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '10px' }}>
                  {currentComps && nextComps && Object.entries(currentComps.core).map(([comp, currentLevel]) => {
              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '10px' }}>
                  {currentComps && nextComps && Object.entries(currentComps.technical).map(([comp, currentLevel]) => {
  ...
  const renderSendSupervisor = () => {
    ...
    const handleSend = () => {
      if (supervisorEmail && message) {
        setSent(true);
        setTimeout(() => {
          setView('trainingPlan');
          setSent(false);
        }, 2000);
      }
    };
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <div style={{ backgroundColor: 'white', border: '3px solid ' + colors.orange, borderRadius: '12px', padding: '24px' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <input
                type="email"
                placeholder="supervisor@pgb.com"
                value={supervisorEmail}
                onChange={(e) => setSupervisorEmail(e.target.value)}
                style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid ' + colors.border, fontSize: '0.9rem', boxSizing: 'border-box' }}
              />
            </div>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <textarea
                placeholder="Add any message for your supervisor..."
                value={message}
                onChange={(e) => setMessage(e.target.value)}
                style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid ' + colors.border, fontSize: '0.9rem', minHeight: '100px', boxSizing: 'border-box', fontFamily: 'sans-serif' }}
              />
            </div>
            ...
            {sent ? (
              <div style={{ backgroundColor: '#D4EDDA', border: '1px solid #C3E6CB', color: '#155724', padding: '12px', borderRadius: '6px', textAlign: 'center', fontWeight: 'bold' }}>
                ✅ Sent successfully!
              </div>
            ) : (
              <button
                onClick={handleSend}
                disabled={!supervisorEmail}
                style={{
                  width: '100%',
                  padding: '12px',
                  backgroundColor: supervisorEmail ? colors.orange : '#CCC',
                  color: colors.cream,
                  border: 'none',
                  borderRadius: '8px',
                  cursor: supervisorEmail ? 'pointer' : 'not-allowed',
                  fontWeight: 'bold',
                  fontSize: '1rem'
                }}
              >
  ...
  const renderScheduleDiscussion = () => {
    ...
    const handleSchedule = () => {
      if (discussionDate && discussionTime) {
        setScheduled(true);
        setTimeout(() => {
          setView('trainingPlan');
          setScheduled(false);
          ...
          <div style={{ backgroundColor: 'white', border: '3px solid #4ECDC4', borderRadius: '12px', padding: '24px' }}>
            ...
            {scheduled ? (
              ...
              <button
                ...
                disabled={!discussionDate || !discussionTime}
                style={{
                  width: '100%',
                  padding: '12px',
                  backgroundColor: discussionDate && discussionTime ? '#4ECDC4' : '#CCC',
                  color: 'white',
                  border: 'none',
                  borderRadius: '8px',
                  cursor: discussionDate && discussionTime ? 'pointer' : 'not-allowed',
                  fontWeight: 'bold',
                  fontSize: '1rem'
                }}
              >
          ...
          <div style={{ backgroundColor: 'white', border: '3px solid #96CEB4', borderRadius: '12px', padding: '24px' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                {[
                  ...
                  <button
                    key={reason}
                    onClick={() => setAssessmentReason(reason)}
                    style={{
                      padding: '10px',
                      backgroundColor: assessmentReason === reason ? colors.navy : colors.light,
                      color: assessmentReason === reason ? 'white' : colors.navy,
            ...
            {submitted ? (
              ...
              <button
                ...
                disabled={!hrEmail || !assessmentReason}
                style={{
                  width: '100%',
                  padding: '12px',
                  backgroundColor: hrEmail && assessmentReason ? '#96CEB4' : '#CCC',
                  color: 'white',
                  border: 'none',
                  borderRadius: '8px',
                  cursor: hrEmail && assessmentReason ? 'pointer' : 'not-allowed',
                  fontWeight: 'bold',
                  fontSize: '1rem'
                }}
              >
